...
def parse_args():
    ...
    # basic parameters
    parser.add_argument('--model_name', type=str, default='GWAN', help='the name of the model')
    ...
    parser.add_argument('--data_dir', type=str, default='./datasets/XJTUSpurgearRadius_constant.pkl', help='the directory of the data')

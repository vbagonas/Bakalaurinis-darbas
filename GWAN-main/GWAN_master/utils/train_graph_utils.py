...
class train_utils(object):
    ...
    def setup(self):
        ...
        self.datasets['train'], self.datasets['val'] = Dataset(args.data_dir, args.Input_type, args.task).data_preprare()
        ...
        def print_model_info(model):
            ...
            params = sum(torch.numel(p) for p in parameters)
            print(f"Number of parameters: {params}")
            print(f"Estimated model size: {params * 4 / 1024 / 1024} MiB")
